...
<head>
    ...
    <link rel="stylesheet" href="styles/admin_contenu.css">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajouter_contenu'])) {
    ...
    try {
        ...
        $statementInsert->execute([$titre, $contenu]);
        ...
        // échec
        echo "Erreur lors de l'ajout du contenu : " . $e->getMessage();
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['supprimer_contenu'])) {
    ...
    try {
        ...
        $statementSuppression = $connexion->prepare($querySuppression);
        $statementSuppression->execute([$idContenu]);
        ...
        // échec
        echo "Erreur lors de la suppression du contenu : " . $e->getMessage();
    }
}
